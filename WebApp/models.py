...
class Tutor(models.Model):
    ...
    rutTutor = models.CharField(max_length=12)
    generoTutor = models.ForeignKey(Genero, on_delete=models.CASCADE)
    telefonoTutor = models.CharField(max_length=9)
    emailTutor = models.EmailField(max_length=100, unique=True)
    
    def __str__(self):
        return f'{self.nombreTutor} {self.apellidoTutor}'
